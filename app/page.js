      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="glass-panel p-10 md:p-16 rounded-[2.5rem] relative overflow-hidden group min-h-[400px] flex flex-col justify-end">
            ...
            <div className="absolute bottom-0 left-0 p-10 opacity-80 group-hover:opacity-100 transition-opacity duration-1000">
            ...
            <Image
              ...
              width={120}
              height={120}
              className="absolute top-20 right-24 w-62 h-62 opacity-80 group-hover:opacity-100 transition-opacity"
            />          </div>
